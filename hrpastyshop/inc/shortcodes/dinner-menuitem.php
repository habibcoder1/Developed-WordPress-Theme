...
add_shortcode('hrdinner-menu', 'hrpasty_dinnermenu_shortcodes');
function hrpasty_dinnermenu_shortcodes($atts, $content){
					...
					$breakfast = new WP_Query(array(
						...
						'tax_query' => array(
							array(
							  ...
							  'field'    => 'slug',
							  'terms'    => array('dinner')  //taxonomy slug name
							)
						)
					));
...
if (function_exists('vc_map')) {
	vc_map(array(
		'name'      => __('Dinner Menu', 'hrpasty'),
		'base'      => 'hrdinner-menu',
		'icon'      => get_template_directory_uri().'/img/vc/dinner-menu.png',
		'category'  => 'HR Pasty',
		'params'    => array(
			array(
				'param_name'   => 'title',
				'heading'      => __('Dinner Section Title', 'hrpasty'),
				'type'         => 'textfield',
				'value'        => 'Dinner Menu',
			),
			array(
