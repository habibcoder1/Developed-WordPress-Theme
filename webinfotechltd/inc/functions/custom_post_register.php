...
function witl_custom_post_type(){
    ...
    if (!post_type_exists('witl-service')) {
    ...
    // register category
    if (!taxonomy_exists('witlser_cate')) {
    ...
    if (!taxonomy_exists('witlser_tags')) {
    ...
    // register category
    if (!taxonomy_exists('witlteam_dep')) {
