...
if(have_posts()) :
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="post_date_author_category flex mt-2 mb-3">
            <a href="<?php echo get_day_link(get_post_time('Y'), get_post_time('m'), get_post_time('j')); ?>" class="date capitalize mr-2 sm:mr-3 md:mr-2 lg:mr-5 transition-all hover:text-[#DD3627]"> <?php the_time('j M Y'); ?></a>
            ...
            <!-- Like/Dislike -->
            <div class="like_dislike ml-2 hidden lg:block">
                <div class="likes_item like inline-block mr-2">
                    <a href="#" class="like-button" data-action="like" data-post-id="<?php echo get_the_id(); ?>" data-post-type="post" data-ajax-url="<?php echo admin_url('admin-ajax.php'); ?>">
                        <i class="fa-solid fa-thumbs-up"></i> </a>
                    (<span class="like-count"><?php echo hr_get_like_count('_likes') ?></span>)
                </div>
                <div class="dislikes_item dislike inline-block">
                    <a href="#" class="dislike-button" data-action="dislike" data-post-id="<?php echo get_the_id(); ?>" data-post-type="post" data-ajax-url="<?php echo admin_url('admin-ajax.php'); ?>">
                        <i class="fa-solid fa-thumbs-down"></i> </a>
                    (<span class="dislike-count"><?php echo hr_get_like_count('_dislikes') ?></span>)
                </div>
            </div>
        </div>
    ...
    <div class="post-social mb-6">
        ...
        <ul class="social-items">
            <!-- facebook -->
            <li class="mr-3"><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $page_url; ?>&title=<?php echo $post_title; ?>" title="Share On Facebook" target="_blank"><i class="fa-brands fa-facebook-f px-[10px] py-2 rounded-lg text-white bg-blue-400 transition-all duration-300 hover:text-[#DD3627]"></i></a></li>
            <!-- twitter -->
            <li class="mr-3"><a href="https://twitter.com/intent/tweet?url=<?php echo $page_url; ?>&text=<?php echo $post_title; ?>" title="Share On Twitter" target="_blank"><i class="fa-brands fa-twitter px-[10px] py-2 rounded-lg text-white bg-blue-600 transition-all duration-300 hover:text-[#DD3627]"></i></a></li>
            <!-- linkedin -->
            <li class="mr-3"><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $page_url; ?>&title=<?php echo $post_title; ?>" title="Share On LinkedIn" target="_blank"><i class="fa-brands fa-linkedin-in px-[10px] py-2 rounded-lg text-white bg-blue-800 transition-all duration-300 hover:text-[#DD3627]"></i></a></li>
            <!-- pinterest -->
            <li><a href="<?php echo $pinterestURL; ?>" title="Share On Pinterest" target="_blank"><i class="fa-brands fa-pinterest-p px-[10px] py-2 rounded-lg text-white bg-red-500 transition-all duration-300 hover:text-[#DD3627]"></i></a></li>
        </ul>
    </div>
    <!-- recommended posts -->
    <?php 
